    ...
    <section id="top" className="relative min-h-screen overflow-hidden pt-32">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-12 lg:grid-cols-12">
        <div className="lg:col-span-7">
          ...
          >
            I'm a beauty, skincare & lifestyle UGC content creator based in India. I started in April 2026 and have already completed 40+ brand collabs in just over a month. I specialise in aesthetic, satisfying, high quality product videos that feel genuine and engaging. I can create content fast and as per your (brand's) requirements.
          </motion.p>
