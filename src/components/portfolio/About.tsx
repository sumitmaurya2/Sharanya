      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 lg:pl-8">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground/70">
            {[
              "I started my UGC journey in April 2025, and in just over a month, I’ve had the pleasure of bringing 30+ brand campaigns to life. What drives me is creating content that doesn't just look beautiful, but actually connects with the audience.",
